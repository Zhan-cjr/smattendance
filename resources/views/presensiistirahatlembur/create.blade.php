        ...
        <div class="time-card">
            ...
            <div class="schedule-info">
                <div class="schedule-item">
                    <div class="schedule-label">Jadwal istirahatlembur</div>
                    <div class="schedule-time">{{ date('H:i', strtotime($jam_kerja->jam_awal_istirahatlembur)) }} - {{ date('H:i', strtotime($jam_kerja->jam_akhir_istirahatlembur)) }}</div>
                </div>
                <div class="schedule-item">
...
<script>
    ...
    $(function() {
        ...
        $('#btn-action').click(function(e) {
            ...
            const btn = $(this);
            const status = $('#status').val(); // istirahatlembur_in or istirahatlembur_out
            ...
            Webcam.snap(function(data_uri) {
                ...
                // Assuming standard presensi logic: we need to check how istirahatlembur controller handles this.
                ...
                $.ajax({
                    type: 'POST',
                    url: '/presensiistirahatlembur', // Corrected route
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
